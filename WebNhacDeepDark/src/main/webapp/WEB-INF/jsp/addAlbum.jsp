    ...
    <div class="main">
        ...
        <div class="d-flex justify-content-center align-items-center">
            <div style="width: 600px" class="bg-white p-4 rounded shadow-sm">
                <form:form modelAttribute="album" cssClass="row  needs-validation" action="/admin/add-album" novalidate="novalidate" method="post">
                    <form:hidden path="idAlbum"/>
                    <h1 class="display-6 text-center">Thêm Album</h1>
                    <c:if test="${add==false}">
                        <div class="alert alert-danger" role="alert">
                            Thêm album không thành công !
                        </div>
                    </c:if>
                    <div class="mb-2">
                    ...
                    <div class="col-12">
                        <button class="btn btn-success me-2" type="submit">Thêm album</button>
...
<script src="/js/admin/addAlbum.js"></script>
