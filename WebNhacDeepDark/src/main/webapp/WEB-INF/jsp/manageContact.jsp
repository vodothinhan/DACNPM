    ...
    <div class="main">
        ...
        <div class="container-table">
            <div style="width: 90% ; padding: 10px ; background: #FFFFFF" >
                <table id="table-contact" class="table table-striped" style="width:100%">
                    <thead>
                    <tr>
                        <th></th>
                        <th>Id</th>
                        ...
                        <tr >
                            ...
                            <td>
                                <div class="form-check no-switch-parent">
                                    <input class="form-check-input no-switch" type="checkbox" value="${contact.id}">
                                    <label class="form-check-label" >
                                            ${contact.id}
                                    </label>
                                </div>
                            </td>
                            <td>${contact==null?"":contact.users.email}</td>
                            <td>
                                <fmt:formatDate pattern = "dd-MM-yyyy"
                                                value = "${contact.dateSend}"/>
                            </td>
                            <td><i data-id="${contact.id}" class="fa-solid fa-comment-dots"></i>
                            </td>

                            <td class="d-none">${contact==null?"":contact.content}</td>
...
<script src="/js/admin/manageContact.js"></script>
