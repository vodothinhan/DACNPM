...
<head>
    ...
    <title>Quản lý nghệ sĩ</title>
</head>
<style>
    .container-table{
        display: flex;
...
<div class="container-admin">
    ...
    <div class="main">
        ...
        <div class="header-manage">
            <h3>Quản lí nghệ sĩ</h3>
        </div>
        <div class="container-table">
            <div style="width: 90% ; padding: 10px ; background: #FFFFFF" >
                <table id="table-singer" class="table table-striped" style="width:100%">
                    <thead>
                    <tr>
                        <th>Id</th>
                        <th>Tên nghệ sĩ</th>
                        ...
                        <tr >
                            <td>
                                <div class="form-check no-switch-parent">
                                    <input class="form-check-input no-switch" type="checkbox" value="${singer.id}">
                            ...
                            <td>${singer.name}</td>
                            <td><i class="fa-solid fa-pen-to-square" data-name = "${singer.name}" data-id="${singer.id}"></i></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
...
<script src="/js/admin/manageSinger.js"></script>
</body>
